...
var toInject = new [] {
    new {
        ...
        Replace = @"{var p = this.loadResource(r,t(r),e[r],n); p.response.then((x) => { if (typeof window.loadResourceCallback === ""function"") { window.loadResourceCallback(Object.keys(e).length, r, x);}}); return p;}"
    },
};
